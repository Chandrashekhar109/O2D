...
function setupApp() {
  ...
  const material = ensureMaterialSheet_();
  Logger.log('Material Availability ready: ' + material.getName());
...
function addSampleUsers() {
  ...
  out.push(addOrUpdateUser('mat.yarn', 'ChangeMe123!', 'Yarn Incharge', 'yarn', ''));
  out.push(addOrUpdateUser('mat.fabric', 'ChangeMe123!', 'Fabric Incharge', 'fabric', ''));
